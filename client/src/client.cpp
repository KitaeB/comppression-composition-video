  ...
  try {
    while (true) {
      ...
      boost::asio::read(socket,
                        boost::asio::buffer(&lz4Decoder1.compressedSize,
                                            sizeof(lz4Decoder1.compressedSize)));

      boost::asio::read(socket,
                        boost::asio::buffer(&lz4Decoder2.compressedSize,
                                            sizeof(lz4Decoder2.compressedSize)));

      boost::asio::read(socket, boost::asio::buffer(&lz4Decoder1.originalSize,
                                                    sizeof(lz4Decoder1.originalSize)));
      ...
      std::cout
          ...
          << " compressed data: "
          << lz4Decoder1.compressedSize + lz4Decoder2.compressedSize
          << " koef: "
  ...
  try {
    while (true) {
      ...
      std::cout
          ...
          << " compressed data: "
          << lz4Decoder1.compressedSize + lz4Decoder1.compressedSize << " koef: "
