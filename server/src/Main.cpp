...
int main(int argc, char *argv[]) {
    ...
    while (true) {
        ...
        try {
            ...
            std::cout << "9. zstd compress, with concat, without prime frame " << std::endl;
            std::cout << "10. zstd compress, with concat, with prime frame" << std::endl;
            std::cout << "11. zstd compress, without concat, without prime frame" << std::endl;
            std::cout << "12. zstd compress, without concat, with prime frame" << std::endl;
